...
def get_filters():
    ...
    MONTH_DATA:['January': 1, 'February': 2, 'March': 3, 'April': 4, 'May': 5, 'June': 6, 'None': 0]
    month = ''
        while month not in MONTH_DATA:
        while month.lower() not in MONTH_DATA:
        month = input("\nPlease choose a month to filter by. \nJanuary: 1, February: 2, March: 3, April: 4, May: 5, June: 6, None: 0 \n")
    ...
    day = ''
        ...
        day = input("\nWhat day would you like to filter by? \nMonday: 1, Tuesday:2, Wednesday: 3, Thursday: 4, Friday: 5, Saturday: 6, Sunday: 7, All: 0)
                    if day in DAY_DATA:
